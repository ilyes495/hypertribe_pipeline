#!/usr/bin/env perl
use warnings;
use lib "/data/kharas/baalii/HyperTribe_SYNCRIP_MOLM13/download_scripts/../software/hypertribe/homer//bin";
my $homeDir = "/data/kharas/baalii/HyperTribe_SYNCRIP_MOLM13/download_scripts/../software/hypertribe/homer/";
